...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Podcast p1 = new Podcast("Código Moderno", 3600, "Lucas", "Perez", "Argentina", TipoPodcast.TECNOLOGIA);
        Podcast p2 = new Podcast("Charlas del Futuro", 2700, "Santiago", "Lopez", "Chile", TipoPodcast.ENTRETENIMIENTO);
        Podcast p3 = new Podcast("Aprendiendo Java", 1800, "Facundo", "Rocha", "Argentina", TipoPodcast.EDUCACION);
        // Agregados
        ...
        // Pruebas de equals
        Podcast p4 = new Podcast("Código Moderno", 3600, "Lucas", "Perez", "Argentina", TipoPodcast.TECNOLOGIA);
        System.out.println("");
